...
const index = () => {
  return (
    <div className='about-us-container flex-column' id='about-us'>
      ...
      <div className='about-us-info' style={{ width: "80%" }}>
        <div className='about-us-inner-info flex-column' style={{ width: "100%" }}>
          <h2>درباره ما</h2>
          ...
          <a className='send-resume-button-link' target='_blank' href='https://quera.org/magnet/companies/nilva' style={{ textDecoration: 'none', color: 'black' }}><button className='send-resume-button' >ارسال رزومه</button></a>
        </div>
      </div>
    </div>
  )
